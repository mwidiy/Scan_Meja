      ...
      `}</style>
            ...
            <div className="app-wrapper">
                ...
                <div className="flex-1">
                    ...
                    {/* TAHAP 67: DUITKU KYC SUPPORT CONTACT FOOTER (REVISED: Quecxel Branding) */}
                    <div className="w-full bg-[#1F2937] mt-[-120px] pt-[30px] pb-[140px] px-[22px] flex flex-col items-center justify-center text-center rounded-t-[32px] relative z-10 shadow-[0_-10px_20px_rgba(15,23,42,0.1)]">
                        ...
                        <img
                            ...
                            alt="Logo Quecxel"
                            className="h-[46px] w-auto object-contain mb-[16px] opacity-100"
                        />
                        ...
                        <div className="flex flex-col gap-[12px] w-full max-w-[300px] bg-white/5 rounded-[20px] p-[18px]">
                            ...
                            <div className="flex items-start gap-[12px]">
                                ...
                                <span className="text-white text-[0.8rem] font-medium text-left leading-[1.4]">
                                    Jl. Halmahera No.KM. 01<br />52121 Jawa Jawa Tengah
                                </span>
                            </div>
                        </div>
                    </div>
